...
public class UsersFacadeREST extends AbstractFacade<Users> {
    ...
    public void create(Users entity) {
        ...
        groupnameandowner.setGroupname(entity.getUserid() + " FRIENDS");
        groupnameandowner.setUserid(entity);
        groupnameandowner.setPriority("special");
